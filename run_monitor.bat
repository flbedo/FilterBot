...
echo ============================================================
echo.
echo Программа будет отслеживать новые сообщения в реальном времени.
echo Релевантные сообщения будут автоматически пересылаться в целевой чат.
echo.
...
echo.
echo ============================================================
echo [ЗАВЕРШЕНО] Мониторинг остановлен
echo ============================================================
pause
